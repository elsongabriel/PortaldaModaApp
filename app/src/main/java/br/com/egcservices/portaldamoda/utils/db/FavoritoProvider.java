...
public class FavoritoProvider { //extends ContentProvider {

  /*  private static final String PATH = "portaldamoda";
    private static final String AUTHORITY = "br.com.egcservices.portaldamoda";
    ...
    public boolean onCreate() {
        mHelper = new PersistenceHelper(getContext());
        return true;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (uriType == TYPE_GENERIC) {
            ...
            long id = db.insert(EmpresaTB.TABLE_NAME, null, values);
            db.close();
...
//          notifyWidget();
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriType) {
            ...
            case TYPE_GENERIC:
                cursor = db.query(EmpresaTB.TABLE_NAME,
